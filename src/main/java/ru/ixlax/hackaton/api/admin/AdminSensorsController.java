// src/main/java/ru/ixlax/hackaton/api/admin/AdminSensorsController.java
...
import ru.ixlax.hackaton.api.publicapi.dto.SensorRegisterDto;
...
public class AdminSensorsController {
    ...
    public Sensor register(@RequestBody SensorRegisterDto dto){ return svc.register(dto); }

    @PostMapping("/push")
    public SensorStatusDto push(@RequestBody MeasurementDto dto){ return svc.push(dto); }
}