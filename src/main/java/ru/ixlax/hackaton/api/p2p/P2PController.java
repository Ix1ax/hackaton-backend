    ...
    public class P2PController {
        ...
        private void upsertIncident(IncidentDto d){
            // попытка обычного сейва — если два узла вставляют одновременно, поймаем 23505 и сделаем merge
            try {
                ...
                // уже вставили параллельно — перечитаем и при необходимости обновим
                incidentRepo.findByExternalId(d.externalId()).ifPresent(existing -> {
